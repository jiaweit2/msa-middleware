...
if __name__ == "__main__":
    ...
    socket_in_config = extract_config(conf, "local_server_xsub", "socket_in_")

    socket_out_config = extract_config(conf, "local_server_xsub", "socket_out_")

    mirror_socket_config = extract_config(conf, "local_server_xsub", "mirror_socket_")
