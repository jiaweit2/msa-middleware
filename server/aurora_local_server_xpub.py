...
if __name__ == "__main__":
    ...
    socket_in_config = extract_config(conf, "local_server_xpub", "socket_in_")

    socket_in1_config = extract_config(conf, "local_server_xpub", "socket_in1_")

    socket_out_config = extract_config(conf, "local_server_xpub", "socket_out_")

    mirror_socket_config = extract_config(conf, "local_server_xpub", "mirror_socket_")
    ...
    try:
        proxy = basic_proxy.BasicProxy(
            socket_in_config, socket_out_config, mirror_socket_config
        )
