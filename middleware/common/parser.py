...
class AthenaParser(object):
    ...
    def load(self, input_str, default_freshness_p=DEFAULT_FRESHNESS_P, custom_markers=dict()):        
        ...
        try:
            ...
            logger.debug("Cannot parse the input")
            return variables
            ...
            if len(stmt.children[0].children) == 1:            
                ...
                if stmt.children[1].data == 'label': 
                    ...
                    for data_set in stmt.children[1].children[2].children:                                                                      
                        prefix_sets.append([str(d.children[0]) for d in data_set.children])

                    variables[var_name] = (LABEL, annotator_func, args, prefix_sets, freshness_p, -1)
                        ...
                        while q:
                            ...
                            if isinstance(curr, Tree):
                                ...
                                if curr.data == 'predicate': 
                                    p_key = (str(curr.children[0].children[0]), 
                                ...
                                logger.debug("%s is not a token: %s", curr, curr.data)                                
                    ...
                    variables[var_name] = (DECISION, Or, coa_validity, inv_predicates, freshness_p)                    
                ...
                for i in range(len(var_names)):
                    variables[var_names[i]] = (LABEL, annotator_func, args, data_sets, freshness_p, i)
